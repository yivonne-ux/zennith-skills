...
> See `references/skill-template.md` for the full copy-paste SKILL.md template with all sections (Purpose, Workflow, Gotchas, Templates, QA Criteria, Batch, Compounding).
